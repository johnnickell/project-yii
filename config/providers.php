...
return [
    'routing-policy' => ['class' => RoutingProvider::class, 'runtime' => true],
    'view-policy' => ['class' => ViewProvider::class, 'runtime' => true],
    'http-application' => ['class' => HttpApplicationProvider::class, 'runtime' => true],
    'security-and-validation' => ['class' => SecurityAndValidationProvider::class, 'runtime' => true],
    ...
    'mail-policy' => ['class' => MailProvider::class, 'runtime' => true],
    'sms-policy' => ['class' => SmsProvider::class, 'runtime' => true],
    'publication-policy' => ['class' => PublicationProvider::class, 'runtime' => true],
    'observability-policy' => ['class' => ObservabilityProvider::class, 'runtime' => true],
